...
## Platform / handler
- Archive operation: move the entire board to "Ended operations" and start fresh on a new operation — including logic for private notes linked to archived cards
